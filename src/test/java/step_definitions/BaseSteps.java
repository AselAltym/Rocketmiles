...
public class BaseSteps {
    ...
    public void user_verifies_the_data() {
        for (User user : users) {
            ...
            System.out.println(objectType+": " + user.getEmail());
            Assert.assertTrue(user.getEmail().toLowerCase().contains("altym.asel@gmail.com".toLowerCase()));
            Assert.assertTrue(user.getBirthday().contains("04/26/1990"));
